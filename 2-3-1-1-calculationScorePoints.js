...
Выводим в консоль игрока с максимальным значением scorePoints. 
Используем цикл, обращение к свойству через точку и метод глобального 
объекта Math, позволяющий найти большее число из всех возможных.

1. Для начала создаем пустой массив для хранения очков
2. Используя цикл, заполняем новый массив значениями очков из данного вам массива players
здесь будет удобнее использовать цикл for..in. 
*/
